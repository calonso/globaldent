...
--
-- Servidor: localhost
-- Tiempo de generación: 11-02-2008 a las 17:36:25
...
ALTER TABLE `asistente`
  ADD CONSTRAINT `asistente_ibfk_1` FOREIGN KEY (`id_visita_medica`) REFERENCES `visita` (`id_visita`) ON DELETE CASCADE,
  ADD CONSTRAINT `asistente_ibfk_2` FOREIGN KEY (`id_personal`) REFERENCES `personal` (`id_personal`) ON DELETE CASCADE;
...
ALTER TABLE `colaborador`
  ADD CONSTRAINT `colaborador_ibfk_1` FOREIGN KEY (`id_visita_medica`) REFERENCES `visita` (`id_visita`) ON DELETE CASCADE,
  ADD CONSTRAINT `colaborador_ibfk_2` FOREIGN KEY (`id_dr_colaborador`) REFERENCES `dr_externo` (`id_dr_externo`) ON DELETE CASCADE;
