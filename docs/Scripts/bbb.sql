...
--
-- Servidor: localhost
-- Tiempo de generación: 13-09-2008 a las 10:32:50
...
CREATE TABLE `articulo` (
  ...
  `annio` varchar(32) collate latin1_spanish_ci default NULL,
...
CREATE TABLE `cita` (
  ...
  KEY `id_usuario` (`id_usuario`),
  KEY `id_paciente` (`id_paciente`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=1478 ;
...
CREATE TABLE `linea_visita` (
  ...
  KEY `id_usuario` (`id_usuario`),
  KEY `id_servicio` (`id_servicio`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=641 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=336 ;
...
CREATE TABLE `opciones` (
  ...
  `reg_sanidad` varchar(32) collate latin1_spanish_ci default NULL,
  `extension` varchar(32) collate latin1_spanish_ci default NULL,
...
CREATE TABLE `paciente` (
  ...
  KEY `id_usuario` (`id_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=1423 ;
...
CREATE TABLE `pagopac` (
  ...
  KEY `id_paciente` (`id_paciente`),
  KEY `id_usuario` (`id_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=264 ;
...
CREATE TABLE `servicio` (
  ...
  KEY `id_usuario` (`id_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=118 ;
...
CREATE TABLE `visita` (
  ...
  `motivo` text collate latin1_spanish_ci,
  `diagnostico` text collate latin1_spanish_ci,
  `observaciones` text collate latin1_spanish_ci,
  ...
  KEY `id_paciente` (`id_paciente`),
  KEY `id_usuario` (`id_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=530 ;
