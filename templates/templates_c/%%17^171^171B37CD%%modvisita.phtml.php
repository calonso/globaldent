<?php /* Smarty version 2.6.20, created on 2009-10-19 18:51:54
         compiled from C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 1, false),array('function', 'counter', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 95, false),array('function', 'math', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 107, false),array('function', 'html_options', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 115, false),array('modifier', 'cat', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 3, false),array('modifier', 'regex_replace', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 71, false),array('modifier', 'default', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/visitas/modvisita.phtml', 100, false),)), $this); ?>
...
index.php/cod.borralineamv/id.<?php echo $this->_tpl_vars['paciente']['id_paciente']; ?>
...
function linea()
{
  ...
  '; ?>
    ...
    x.action = "<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.nuevalineamv/id.<?php echo $this->_tpl_vars['paciente']['id_paciente']; ?>
/vis.<?php echo $this->_tpl_vars['datos']['id_visita']; ?>
";
  <?php echo '
  x.submit();
...
index.php/cod.actualizavisita/id.<?php echo $this->_tpl_vars['paciente']['id_paciente']; ?>
/vis.<?php echo $this->_tpl_vars['datos']['id_visita']; ?>
">
...
js/fckeditor/";
        ...
        <p><?php echo $this->_config[0]['vars']['texto18']; ?>
          ...
          <script type="text/javascript">
            var oFCKeditor = new FCKeditor('txtDiag','100%','200','MyToolbar','<?php echo ((is_array($_tmp=$this->_tpl_vars['datos']['diagnostico'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/[\r\n]/", "") : smarty_modifier_regex_replace($_tmp, "/[\r\n]/", "")); ?>
');
            oFCKeditor.BasePath = "<?php echo $this->_tpl_vars['req_base']; ?>
js/fckeditor/";
            oFCKeditor.Config['ToolbarStartExpanded'] = false ;
...
" onclick="linea()"/></td>
 ...
 €.</th>
        ...
        <script type="text/javascript">
          var oFCKeditor = new FCKeditor('txtObservaciones','100%','200','MyToolbar','<?php echo ((is_array($_tmp=$this->_tpl_vars['datos']['observaciones'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/[\r\n]/", "") : smarty_modifier_regex_replace($_tmp, "/[\r\n]/", "")); ?>
');
          oFCKeditor.BasePath = "<?php echo $this->_tpl_vars['req_base']; ?>
js/fckeditor/";
          oFCKeditor.Config['ToolbarStartExpanded'] = false ;
...
" value=0><?php echo $this->_config[0]['vars']['texto48']; ?>
              ...
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['pers'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['datos']['pers'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))), $this);?>
...
" value=0><?php echo $this->_config[0]['vars']['texto52']; ?>
              ...
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['dres'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['datos']['col'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))), $this);?>
