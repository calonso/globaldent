<?php /* Smarty version 2.6.20, created on 2009-10-08 21:13:57
         compiled from C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/tiporecetas.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/tiporecetas.phtml', 1, false),array('modifier', 'cat', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/tiporecetas.phtml', 3, false),)), $this); ?>
 ...
 ?>
  ...
  <div class="contenidos">
    <div class="col_central">
      <span class="intro"><?php echo $this->_config[0]['vars']['texto85']; ?>
</span>
      ...
      <?php if (is_array ( $this->_tpl_vars['datos'] )): ?>
        <table width="98%" border="0">
          <tr>
            <th colspan="3"><?php echo $this->_config[0]['vars']['texto68']; ?>
</th>
            <th>&nbsp;</th>
          </tr>
...
?>
          <tr>
            <td colspan="3"><?php echo $this->_tpl_vars['receta']['nombre']; ?>
</td>
            <td>
              <a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.modtiporec/id.<?php echo $this->_tpl_vars['receta']['id_tipo_receta']; ?>
...
icover.ico alt=<?php echo $this->_config[0]['vars']['ver']; ?>
 ...
 /></a>
              <a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.borratiporec/id.<?php echo $this->_tpl_vars['receta']['id_tipo_receta']; ?>
><img src=<?php echo $this->_tpl_vars['img_path_base']; ?>
icoborrar.ico alt=<?php echo $this->_config[0]['vars']['borrar']; ?>
 ...
 width="16px" height="16px" /></a>
      ...
      <?php else: ?>
        ...
        <a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.nuevotiporec><?php echo $this->_config[0]['vars']['texto88']; ?>
</a>
      <?php endif; ?>
    </div>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
