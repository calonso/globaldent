<?php /* Smarty version 2.6.20, created on 2009-06-22 19:03:00
         compiled from C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/pacientes/busquedapacientes.phtml */ ?>
...
-->
  ...
  <div class="contenidos">
    <div class="col_central">
      <span class="intro"><?php echo $this->_config[0]['vars']['texto65']; ?>
</span>
    <?php if ($this->_tpl_vars['codigo'] == 0): ?>
      <p><?php echo $this->_config[0]['vars']['texto66']; ?>
</p>
    <?php else: ?>
...
index.php/cod.nuevopaciente><?php echo $this->_config[0]['vars']['texto2']; ?>
      ...
      <li><a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.buscapacientes><?php echo $this->_config[0]['vars']['texto68']; ?>
</a></li>
      <li><a href=<?php echo $this->_tpl_vars['req_base']; ?>
