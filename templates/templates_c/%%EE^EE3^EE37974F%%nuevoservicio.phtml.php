<?php /* Smarty version 2.6.20, created on 2009-10-08 21:12:32
         compiled from C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/nuevoservicio.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/nuevoservicio.phtml', 1, false),array('modifier', 'cat', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conf/nuevoservicio.phtml', 3, false),)), $this); ?>
...
<div class="contenidos">
  <div class="col_izq">
    <span class="intro"><?php echo $this->_config[0]['vars']['texto9']; ?>
</span>
...
index.php/cod.altaservicio">
      <fieldset><legend><?php echo $this->_config[0]['vars']['texto13']; ?>
</legend>
        <p><?php echo $this->_config[0]['vars']['texto5']; ?>
</p><input type="text" name="txtNombre" /><br />
        <p><?php echo $this->_config[0]['vars']['texto6']; ?>
</p><input type="text" name="txtPrecio" />€<br />
