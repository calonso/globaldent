<?php /* Smarty version 2.6.20, created on 2009-10-19 19:04:48
         compiled from C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conta/vercaja.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conta/vercaja.phtml', 1, false),array('function', 'counter', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conta/vercaja.phtml', 43, false),array('function', 'math', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conta/vercaja.phtml', 70, false),array('modifier', 'cat', 'C:/dev/apache/htsdocs/globaldent/templates/templates/web/gbdapp/conta/vercaja.phtml', 3, false),)), $this); ?>
...
<?php echo '
var patron = new RegExp("pagavisita");
var patron2 = new RegExp ("modpagopac");
var patron3 = new RegExp ("borrapagopac");
'; ?>


if (patron.test(location.href) || patron2.test(location.href) || patron3.test(location.href))
  location.href= "<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.vercaja";
<?php echo '
<!--
function pagar (idp)
{
  document.fpago.idpaciente.value = idp;
  var x = document.getElementById (idp + "Tarj");
  document.fpago.tarjeta.value = x.value;
  x = document.getElementById (idp + "Met");
  document.fpago.efectivo.value = x.value;
...
?>
        <?php if ($this->_tpl_vars['visita']['fsa'] != 1): ?>
...
/<?php echo $this->_tpl_vars['visita']['pagos']['efect']; ?>
            ...
            <?php if ($this->_tpl_vars['visita']['saldo'] < 0): ?>
              ...
              <td align="center">
                <input type="text" id="<?php echo $this->_tpl_vars['visita']['id_paciente']; ?>
Tarj" size="5" value="0"/>
                <input type="text" id="<?php echo $this->_tpl_vars['visita']['id_paciente']; ?>
Met" size="5" value="0"/> 
                <input type="button" value=<?php echo $this->_config[0]['vars']['texto25']; ?>
 onclick="pagar(<?php echo $this->_tpl_vars['visita']['id_paciente']; ?>
)"/>
              </td>
            <?php else: ?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['visita']['pagos']['tarj'] != 0 || $this->_tpl_vars['visita']['pagos']['efect'] != 0): ?>
              <td>
                <a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.editapagopac/id.<?php echo $this->_tpl_vars['visita']['id_paciente']; ?>
...
icoedit.png /></a>
        ...
        <form name="fpago" method="POST" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.pagavisita">
        ...
        <form name="modpago" method="POST" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.modpagopac">
          <input type="hidden" name="idpaciente" value="0" />
          <input type="hidden" name="efectivo" value="0" />
          <input type="hidden" name="tarjeta" value="0" />
...
/<?php echo $this->_tpl_vars['pago']['efect']; ?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['pago']['tarj'] != 0 || $this->_tpl_vars['pago']['efect'] != 0): ?>
              <td>
                <a href=<?php echo $this->_tpl_vars['req_base']; ?>
index.php/cod.editapagopac/id.<?php echo $this->_tpl_vars['pago']['id_paciente']; ?>
><img src=<?php echo $this->_tpl_vars['img_path_base']; ?>
icoedit.png /></a>
              </td>
            <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
      <li><input type="button" value="<?php echo $this->_config[0]['vars']['texto37']; ?>
" onclick="abrir()" /></li>
